...
class ParkingPtsSelection:
    ...
    def draw_bounding_box(self, box):
        ...
        Args:
            box (list): Bounding box data containing two points [(x0, y0), (x1, y1)]
        """
        x0, y0 = box[0]
        x1, y1 = box[1]
    ...
    def save_to_json(self):
        ...
        for box in self.bounding_boxes:
            ...
            # Ensure the bounding box is represented by four points
            if len(rescaled_box) == 2:
                x0, y0 = rescaled_box[0]
                x1, y1 = rescaled_box[1]
                rescaled_box = [
